    ...
    <Layout>
      <CareerParagraphRow>
        <Col lg={{ span: 24 }} xxl={{ span: 8, offset: 4 }}>
          ...
          <PStyled>
            Միանալով մեր թիմին,
            Դուք ավելին եք ստանում, քան պարզապես աշխատանք: Դուք դառնում եք Triple Consulting- ի առողջ, բարձրորակ մշակույթի  մի մասը, որտեղ մարդիկ իրենց զգում են գնահատված, հարգված և խրախուսված՝ իրենց  յուրահատուկ ունակություններն օգտագործելու  համար:
          </PStyled>
        </Col>
      </CareerParagraphRow>
      {careerdata.map((d, id) => (
