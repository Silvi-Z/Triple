    ...
    <Layout>
      <HeadingParagraphRow>
        <Col lg={{ span: 22, offset: 2 }} xl={{ span: 24, offset: 2 }} xxl={{ span: 18, offset: 4 }}>
          ...
          <PStyled>
            Թրիփլ Քոնսալթինգի կողմից մատոցվող հաշվապահական համալիր ծառայությունների միջոցով մոռացեք հաշվապահական հաշվառման հետկապած խնդիրների մասին, խուսափեք հավելյալ հարկային բեռից, խնայեք ժամանակ՝ նվիրելով այն Ձեր բիզնեսի առաջխաղացմանը։ Մեր ընկերության մատուցվող ծառայություններին կարող եք ծանոթանալ ստորեւ:
          </PStyled>
        </Col>
      </HeadingParagraphRow>
