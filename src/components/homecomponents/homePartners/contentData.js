...
const contentData = [
  {
    "src" : `${AlgorithmImg}`,
    "name" : "Ալգորիթմ Սոլուշնս",
    "sphere" : "ՏՏ ոլորտ"
  },
  {
    "src" : `${AbcImg}`,
    "name" : "Էյ Բի Սի Դոմեյն",
    "sphere" : "Կապի ոլորտ"
  },
  {
    "src" : `${KochonImg}`,
    "name" : "Կոչոն",
    "sphere" : "Գյուղատնտեսություն"
  },
  {
    "src" : `${OSN}`,
    "name" : "Օնլայն Շոփինգ Նեթվորք",
    "sphere" : "Առաքման ծառայություն"
  },
  {
    "src" : `${BestSolutions}`,
    "name" : "Բեսթ Սոլուշնս",
    "sphere" : "Իրավաբանական ծառայություն"
  },
  {
    "src" : `${Sky}`,
    "name" : "Սքայ Լաբ",
