...
const VacationCalculator = ({ langText }) => {
  ...
  return (
    <>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Description
          text={"Այն ամիս(ներ)ը, երբ աշխատակիցը գտնվել է արձակուրդում, անաշխատունակության մեջ կամ այլ պատճառով բացակայել է աշխատանքից` չլրացնել"} />
